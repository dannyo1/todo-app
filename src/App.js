...
const App = () => {
   ...
   */
  const addTask = () => {tasks = [...tasks, currTask]};
      ...
      <div id="content">
        ...
        <Form>
          <Form.Group controlId="form-input">
             ...
             */}
            <FormControl placeholder = "enter a task babe" onChange={handleInput(event)}/>
            <InputGroup.Append>
